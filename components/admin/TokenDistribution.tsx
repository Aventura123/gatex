  ...
  const formatNumber = (num: number): string => {
    ...
    return (
      <div className="bg-black/30 p-4 md:p-6 rounded-xl border border-gray-700">
        <h2 className="text-lg md:text-xl font-bold text-orange-400 mb-4 md:mb-6">Token Distribution</h2>
  ...
  return (
    <div className="bg-black/30 p-4 md:p-6 rounded-xl border border-gray-700 hover:border-orange-500 transition-colors">
      ...
      <div className="mb-4 md:mb-6">
        <h2 className="text-lg md:text-xl font-bold text-orange-400">Token Distribution</h2>
      </div>
      ...
      {error && (
        ...
        <div className="space-y-4 md:space-y-6">          {/* Service Status */}
          <div className="bg-black/70 border border-orange-700 rounded-xl p-4 md:p-6 backdrop-blur-sm">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4 space-y-2 md:space-y-0">
              <div className="flex items-center space-x-3">
                <h3 className="text-lg md:text-xl font-bold text-orange-400">Service Status</h3>
              ...
              <button
                ...
                disabled={refreshing}
                className="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 disabled:opacity-60 font-semibold shadow text-sm w-full md:w-auto flex items-center justify-center space-x-2"
              >
                <svg 
